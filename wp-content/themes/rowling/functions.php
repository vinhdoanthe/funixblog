...
class Nghiennet89_Menu_Walker extends Walker_Nav_Menu {
    ...
    function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
        ...
        $displayButtonExplain = false;
        if (strpos($class_names, 'menu-item-has-children') > -1) $displayButtonExplain = true;
        ...
        if($displayButtonExplain) $item_output .= '<span class="btn-explain-menu">+</span><a' . $attributes . '>';
...
if (!function_exists('rowling_setup')) {
    ...
    function rowling_setup() {
        ...
        register_nav_menu('primary_bottom', __('Primary Bottom Menu', 'rowling'));
...
if (!function_exists('rowling_sidebar_registration')) {
    ...
    function rowling_topbar_registration() {
        register_sidebar(array(
            'name'          => __('Topbar', 'rowling'),
            'id'            => 'topbar',
            'description'   => __('Widgets in this area will be shown in the topbar.', 'rowling'),
            'before_title'  => '<h3 class="widget-title">',
            'after_title'   => '</h3>',
            'before_widget' => '<div class="widget %2$s"><div class="widget-content">',
            'after_widget'  => '</div><div class="clear"></div></div>'
    ...
    function rowling_footerbar1_registration() {
        register_sidebar(array(
            'name'          => __('Footerbar 1', 'rowling'),
            'id'            => 'footerbar1',
            'description'   => __('Widgets in this area will be shown in the footerbar1.', 'rowling'),
            'before_title'  => '<h3 class="widget-title">',
            'after_title'   => '</h3>',
            'before_widget' => '<div class="widget %2$s"><div class="widget-content">',
            'after_widget'  => '</div><div class="clear"></div></div>'
    ...
    function rowling_footerbar2_registration() {
        register_sidebar(array(
            'name'          => __('Footerbar 2', 'rowling'),
            'id'            => 'footerbar2',
            'description'   => __('Widgets in this area will be shown in the footerbar2.', 'rowling'),
            'before_title'  => '<h3 class="widget-title">',
            'after_title'   => '</h3>',
            'before_widget' => '<div class="widget %2$s"><div class="widget-content">',
            'after_widget'  => '</div><div class="clear"></div></div>'
    ...
    function rowling_footerbar3_registration() {
        register_sidebar(array(
            'name'          => __('Footerbar 3', 'rowling'),
            'id'            => 'footerbar3',
            'description'   => __('Widgets in this area will be shown in the footerbar3.', 'rowling'),
            'before_title'  => '<h3 class="widget-title">',
            'after_title'   => '</h3>',
            'before_widget' => '<div class="widget %2$s"><div class="widget-content">',
            'after_widget'  => '</div><div class="clear"></div></div>'
    ...
    add_action('widgets_init', 'rowling_topbar_registration');
    add_action('widgets_init', 'rowling_footerbar1_registration');
    add_action('widgets_init', 'rowling_footerbar2_registration');
    add_action('widgets_init', 'rowling_footerbar3_registration');
                ...
                if ($related_posts) :
                    ...
                    foreach ($related_posts as $related_post) : ?>
                        ...
                        <a class="related-post" href="<?php echo get_the_permalink($related_post->ID); ?>"
                           title="<?php the_title_attribute(array('post' => $related_post->ID)); ?>">
                ...
                <?php foreach ($images as $image) {
                    ...
                    <li>
                        ...
                        if (!empty($image->post_excerpt) && is_single()) : ?>
                            ...
                            <p class="post-image-caption"><span
                                        class="fa fw fa-camera"></span><?php echo $image->post_excerpt; ?></p>
    ...
    <div id="comment-<?php comment_ID(); ?>" class="comment">
        ...
        <?php if ($comment->user_id === $post->post_author) : ?>
            ...
            <a class="comment-author-icon" href="<?php echo esc_url(get_comment_link($comment->comment_ID)); ?>"
               title="<?php _e('Comment by post author', 'rowling'); ?>">
        ...
        <div class="comment-inner">
            ...
            <div class="comment-meta">
                ...
                <div class="fleft">
                    <div class="fa fw fa-clock-o"></div>
                    <a class="comment-date-link" href="<?php echo esc_url(get_comment_link($comment->comment_ID)); ?>"
                       title="<?php echo get_comment_date() . ' at ' . get_comment_time(); ?>"><?php echo get_comment_date(get_option('date_format')); ?></a>
